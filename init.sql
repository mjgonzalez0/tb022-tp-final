...
values
    ('f26929ab-e5db-4544-acc8-bd052c6ff4b3', 'Mateo', 'mateo@example.com', '$argon2id$v=19$m=19456,t=2,p=1$jwQ9xczE8i6RonCbWnOkrg$DTvj2Ku1l7iwGUYCsxV736vELR2zokKQaVBjUSzGsVY', 'Desarrollador Web', 'Argentina'),
    ('1422f821-1ac5-4324-90fe-9e34229f7987', 'antfu', 'antfu@example.com', '$argon2id$v=19$m=19456,t=2,p=1$jwQ9xczE8i6RonCbWnOkrg$DTvj2Ku1l7iwGUYCsxV736vELR2zokKQaVBjUSzGsVY', 'A ship in harbor is safe, but that is not what ships are built for.', 'undefined'),
    ('3e302e0b-1d83-42a7-ad62-a7d13d3f0d04', 'fabian-hiller', 'fh@example.com', '$argon2id$v=19$m=19456,t=2,p=1$jwQ9xczE8i6RonCbWnOkrg$DTvj2Ku1l7iwGUYCsxV736vELR2zokKQaVBjUSzGsVY', 'Creator of Valibot, creator of Formisch, co-creator of Standard Schema and engineer at Motion', 'New York, US'),
